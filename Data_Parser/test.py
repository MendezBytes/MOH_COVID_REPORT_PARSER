...
kernel_len_vert = np.array(img).shape[1] // 75
kernel_len_horiz = np.array(img).shape[1] // 50
# Defining a vertical kernel to detect all vertical lines of image
ver_kernel = cv2.getStructuringElement(cv2.MORPH_RECT, (1, kernel_len_vert))
# Defining a horizontal kernel to detect all horizontal lines of image
hor_kernel = cv2.getStructuringElement(cv2.MORPH_RECT, (kernel_len_horiz, 1))
# A kernel of 2x2
